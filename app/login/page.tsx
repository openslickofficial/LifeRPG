        ...
        <Card className="border-border/80 bg-card/95 shadow-elevated rounded-3xl border p-0 backdrop-blur-xl">
          ...
          <CardContent className="space-y-4 p-8 pt-4">
            ...
            <Button
              ...
              className="border-border/80 h-13 w-full justify-center gap-3 rounded-2xl border-2 text-xs font-black tracking-wider uppercase sm:text-sm"
            >
            ...
            <Button
              ...
              className="h-13 w-full justify-center gap-3 rounded-2xl bg-slate-900 text-xs font-black tracking-wider text-white uppercase shadow-[0_5px_0_0_#0f172a] active:translate-y-[4px] sm:text-sm dark:bg-slate-800 dark:shadow-[0_5px_0_0_#020617]"
            >
            ...
            <div className="pt-2 text-center">
              ...
              >
                <Button
                  variant="gold"
                  size="sm"
                  className="h-10 w-full rounded-xl text-xs font-black tracking-wider uppercase"
                >
                  <span>🚀 Instant Demo Realm Preview</span>
                </Button>
              </Link>
            </div>
          </CardContent>
