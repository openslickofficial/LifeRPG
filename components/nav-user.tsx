        ...
        <DropdownMenu>
          ...
          >
            ...
            <DropdownMenuItem
              ...
              className="cursor-pointer rounded-lg px-2 py-1.5 font-heading text-xs font-bold text-rose-600 transition-colors hover:bg-rose-500/10 dark:text-rose-400"
            >
